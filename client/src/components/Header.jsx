...
//               alt="Profile" />
//             ) : (
//               <li className="flex  gap-1 items-center bg-white px-6 py-3 border border-blue-700 rounded-3xl text-slate-700 font-semibold hover:bg-blue-600 hover:text-white hover:opacity-75 cursor-pointer transition duration-300">

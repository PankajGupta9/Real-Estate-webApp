...
const Search = () => {
    ...
    useEffect(() => {
        ...
        const fetchListings = async () => {
         ...
         fetchListings();
      }, [location.search]); // Added dependency array
  ...
  return (
    ...
    <h4 className='text-3xl font-semibold border-b  text-slate-700 mt-5 p-5'>Listed Properties..</h4>
...
<div className="bg-white p-7 border border-slate-500 rounded-xl m-5  h-[600px">
 <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
     ...
     <button className='bg-slate-700 text-white p-3 rounded-lg uppercase hover:opacity-90'>Search</button>
       ...
       <div className="flex-1  gap-2 mt-20">

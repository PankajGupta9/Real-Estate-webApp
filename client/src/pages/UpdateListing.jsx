...
const UpdateListing = () => {
  ...
  return (
    <main className="p-3 max-w-4xl mx-auto">
      <h1 className="text-3xl font-semibold text-center my-7 uppercase">Update  Property</h1>
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <div className="flex flex-col gap-2 mt-4">
            ...
            <button
                ...
                type="submit"
                className="p-3 bg-orange-700 text-white rounded-lg uppercase hover:opacity-75"
                >
